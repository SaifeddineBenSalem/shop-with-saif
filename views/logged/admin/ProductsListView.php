...
$products = $productsControler->getAllProducts();
                ...
                <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Responsive Table</h6>
                             <a href="index.php?action=addproduct" class="btn btn-primary btn-lg px-4 py-2">
                                ...
                                <table class="table"  id="example">
                                    ...
                                    <tbody>
                                           ...
                                           <?php foreach($products as $product) {?>
                                            ...
                                            <td><?php echo $product["posting_date"];?></td>
                                            <td><?php echo $product["poster"];?></td>
                                            <td><?php echo $product["status"];?></td>
                                            <td><a href="index.php?action=viewproduct&id=<?php echo $product["id"];?>">View Product </a></td>
                                                </tr>
                                            <?php }?>
