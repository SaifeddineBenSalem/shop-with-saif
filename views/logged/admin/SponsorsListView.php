...
$categories = $sponsorsControler->getAllSponsors();
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Responsive Table</h6>
                               <a href="index.php?action=addsponsor" class="btn btn-primary btn-lg px-4 py-2">
                            ...
                            <div class="table-responsive">
                                <table class="table"  id="example">
                                    ...
                                    <tbody>
                                            ...
                                            <td><a href="index.php?action=viewsponsor&id=<?php echo $category["id"];?>">View sponsor </a></td>
                                                </tr>
                                            <?php }?>
