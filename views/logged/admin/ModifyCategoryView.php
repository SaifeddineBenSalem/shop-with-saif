...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $categoryControler->updateCategory($id,$_POST["categoryName"],$_SESSION["login"]);
    header("Location: index.php?action=viewcategory&id=".$id);
}
?>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-100 bg-light rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-6 text-center">
                         <h2 class="form-header">Update a category</h2>
                <form  method="POST">
                    <div class="form-group">
                        <label for="categoryName" class="form-label">Category Name</label>
                        <input type="text" value="<?php echo $id;?>" name="categoryId" hidden/>
                        <input type="text" id="categoryName" value="<?php echo $category["name"] ? $category["name"] : "" ?>" name="categoryName" class="form-control" placeholder="Enter category name" required>
                    </div><br>
