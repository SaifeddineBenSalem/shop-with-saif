...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['sponsorName'], $_FILES['sponsorPhoto'])) {
        $sponsorName = htmlspecialchars($_POST['sponsorName']);
         $uploadDir = '../../inc/logged/img/sponsors/';
 ...
 if (!is_dir($uploadDir)) {
        ...
        if (move_uploaded_file($_FILES['sponsorPhoto']['tmp_name'], $uploadFile)) {
            try {
                ...
                if ($sponsorsControler->addSponsor(basename($_FILES['sponsorPhoto']['name']),$poster,$sponsorName)) {
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-100 bg-light rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-6 text-center">
                         <h2 class="form-header">Add a new sponsor</h2>
                <form method="POST" enctype="multipart/form-data">
    <div class="form-group">
        <label for="sponsorName" class="form-label">Sponsor Name</label>
        <input type="text" id="sponsorName" name="sponsorName" class="form-control" placeholder="Enter sponsor name" required>
    </div>
    <br>
    <div class="form-group">
        <label for="sponsorPhoto" class="form-label">Upload Photo</label>
        <input type="file" id="sponsorPhoto" name="sponsorPhoto" class="form-control" accept="image/*" required>
    </div>
    <br>
