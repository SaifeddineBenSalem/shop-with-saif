...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $resetPasswordControler = new ResetPasswordControler();
    $resetPasswordControler->verifyUserResetPassword($email,$security_question,$security_answer);
}
if (isset($_SESSION["login"])) {
    // Optionally log the session value for debugging
    error_log("Session 'login' is set: " . $_SESSION["login"]);
    header("Location: logged/index.php");
    exit; // It's a good practice to call exit after header redirection to stop further code execution
} else {
    // Log if the session is not set
    error_log("Session 'login' is NOT set.");
}
$message_error=null;
    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Reset password form</h2>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="security_question">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Security answer</label>
                                    <input class="input--style-4" type="text" name="security_answer">
                                </div>
                            </div>
